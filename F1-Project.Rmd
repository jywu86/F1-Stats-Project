...
circuit <- transform(circuit, track_group = ifelse(Avg_Speed_MPH<120, 'Low_Speed',ifelse(Avg_Speed_MPH<150, 'Med_Speed','High_Speed')))
circuit %>% 
  ggplot(aes(x=Avg_Speed_MPH, color=track_group)) + geom_histogram(binwidth=2) + facet_grid()
```
